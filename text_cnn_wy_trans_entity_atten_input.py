...
from attention import multihead_attention,attention_entity_aware
...
class TextCNN:
    def __init__(self, sequence_length, num_classes,
        ...
        #attention entity
        # self.entity_aware_output = attention_entity_aware(self.self_attn_output, self.input_e1, self.input_e1)
        # self.text_embedded_chars_change = tf.layers.dense(self.entity_aware_output, units=300, activation=tf.nn.relu,
