...
from text_cnn_wy_trans_pos_post import TextCNN
import data_helper2
import utils
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn = TextCNN(
                ...
                postion_vocab_size=len(pos_vocab_processor.vocabulary_),
                postion_embedding_size =FLAGS.position_embedding_dim,
            ...
            # Generate batches
            batches = data_helper2.batch_iter(list(zip(train_text, train_y,train_x_pos, train_p1,train_p2)),
            ...
            for batch in batches:
                train_bx,  train_by, train_pos, train_bpos1, train_bpos2 = zip(*batch)
                # print(x_batch)
                # print(list(x_batch))
                ...
                feed_dict = {
                    ...
                    cnn.input_p1:train_bpos1,
                    cnn.input_p2:train_bpos2,
                ...
                if step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    # Generate batches
                    test_batches = data_helper2.batch_iter(list(zip(test_text, test_y,test_x_pos, test_p1, test_p2)),
                    ...
                    for test_batch in test_batches:
                        test_bx, test_by,test_pos,test_bp1,test_bp2 = zip(*test_batch)
                        a = list(test_bx)
                        # print(a)
