...
from text_cnn_wy_trans_entity_att import TextCNN
import data_helper2
import utils
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Generate batches
            batches = data_helper2.batch_iter(list(zip(train_text, train_y,train_x_pos,train_e1, train_e2)),
            ...
            for batch in batches:
                train_bx,  train_by, train_pos,train_be1,train_be2 = zip(*batch)
                # print(x_batch)
                # print(list(x_batch))
                ...
                if step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    # Generate batches
                    test_batches = data_helper2.batch_iter(list(zip(test_text, test_y,test_x_pos,test_e1, test_e2)),
                    ...
                    for test_batch in test_batches:
                        test_bx, test_by,test_pos,test_be1, test_be2 = zip(*test_batch)
                        a = list(test_bx)
                        # print(a)
