...
from text_cnn_wy_trans_pos import TextCNN
import datahelper3
import utils
...
def train():
    with tf.device('/cpu:0'):
        train_text, train_y,train_text_pos, train_e1, train_e2, train_pos1, train_pos2,train_sentence_len = datahelper3.load_data_and_labels(FLAGS.train_path)
    with tf.device('/cpu:0'):
        test_text, test_y, test_text_pos, test_e1, test_e2, test_pos1, test_pos2, test_sentence_len = datahelper3.load_data_and_labels(FLAGS.test_path)
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Generate batches
            batches = datahelper3.batch_iter(list(zip(train_text, train_y, train_x_pos)),
            ...
            for batch in batches:
                ...
                if step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    # Generate batches
                    test_batches = datahelper3.batch_iter(list(zip(test_text, test_y, test_x_pos)),
