...
class TextCNN:
    def __init__(self, sequence_length, num_classes,pos_vocab_size,pos_embedding_size,
        ...
        self.text_embedded_chars = tf.placeholder(tf.float32, shape=[None, sequence_length, 3072], name='text_embedded_chars')
        ...
        # with tf.variable_scope("self-attention"):
            ...
            self.self_attn = tf.layers.dense(self.embedded_chars, units=768,
