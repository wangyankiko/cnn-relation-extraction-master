...
class TextCNN:
    def __init__(self, sequence_length, num_classes,
        ...
        self.text_embedded_chars = tf.placeholder(tf.float32, shape=[None, sequence_length, 1024], name='text_embedded_chars')
        ...
        with tf.variable_scope("self-attention"):
            self.self_attn_output, self.self_alphas = multihead_attention(self.self_attn, self.embedded_chars,
                                                                   num_units=300, num_heads=num_heads)
