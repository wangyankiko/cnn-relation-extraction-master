...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Generate batches
            train_batches = data_helper2.batch_iter(list(zip(id_train,train_x, train_y, train_text,
            ...
            for train_batch in train_batches:
                ...
                if step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    # Generate batches
                    test_batches = data_helper2.batch_iter(list(zip(id_test,test_x, test_y, test_text,
