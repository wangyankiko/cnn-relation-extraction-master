    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                e1_embedd = np.mean(text_embedded_chars[0][train_be1_start[0]:train_be1_end[0]+1],axis=0)
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    for test_batch in test_batches:
                        ...
                        test_e1_embedd = np.mean(text_embedded_chars[0][test_be1_start[0]:test_be1_end[0]+1],axis=0)
                        # print(e1_embedd.shape)
                        test_e2_embedd = np.mean(test_text_embedded_chars[0][test_be2_start[0]:test_be2_end[0]+1], axis=0)
                        for i in range(1, test_text_embedded_chars.shape[0]):
                            test_e1 = np.mean(test_text_embedded_chars[i][test_be1_start[i]:test_be1_end[i] + 1], axis=0)
                            # print("e1 shape", test_e1.shape)
                            test_e2 = np.mean(test_text_embedded_chars[i][test_be2_start[i]:test_be2_end[i] + 1], axis=0)
