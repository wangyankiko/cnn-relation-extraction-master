...
from entity_att_lstm_wy import EntityAttentionLSTM
import utils
import data_helper2
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for train_batch in train_batches:
                train_bx1, train_by, train_btxt, train_be1, train_be2, train_bp1, train_bp2= zip(*train_batch)
                text_embedded_chars = bc.encode(list(train_btxt))
                # text_embedded_chars = server_bert.load_vector("embedding_unclean_2.npy", list(train_bx))  # [20 90 768)
                feed_dict = {
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    for test_batch in test_batches:
                        test_bx1, test_by, test_btxt, test_be1, test_be2, test_bp1, test_bp2= zip(*test_batch)
                        # test_text_embedded_chars = server_bert.load_vector("embedding_unclean_test_2.npy", list(test_bx))  # [20 90 768)
                        test_text_embedded_chars = bc.encode(list(test_btxt))
                        feed_dict = {
