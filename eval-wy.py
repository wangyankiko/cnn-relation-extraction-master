...
def eval():
    with tf.device('/cpu:0'):
        x_text, y, pos1, pos2 ,x_text_clean = data_helpers.load_data_and_labels(FLAGS.test_path)
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                # print(a[0])
                # print(list(a[0]))
                text_embedded_chars_dev = server_bert.load_vector("embedding_test.npy", list(a[0]))
