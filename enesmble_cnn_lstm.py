...
class TextCNN:
    def __init__(self, sequence_length, num_classes,
        ...
        with tf.variable_scope("output"):
            self.enesmble = tf.concat([self.h_pool_flat_dense, self.h_drop_dense], axis=1)
            self.logits = tf.layers.dense(self.enesmble, num_classes, kernel_initializer=initializer())
