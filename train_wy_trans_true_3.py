...
from text_cnn_wy_trans_true import TextCNN
import data_helpers
import utils
...
def train():
    ...
    with tf.device('/cpu:0'):
        test_text, test_y, test_pos1, test_pos2, x_test_clean, test_sentence_len = data_helpers.load_data_and_labels(FLAGS.test_path)
    ...
    id_to_x_text = {}
    id_test = []
    for i, str1 in enumerate(x_test_clean):
        x_text_to_id[str1] = i
        id_to_x_text[i] = str1
        id_test.append(i)
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                # Train
                text_embedded_chars = server_bert.load_vector("embedding_case_2.npy", list(train_bx)) #[20 90 768]
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    for test_batch in test_batches:
                        ...
                        a = list(test_bx)
                        # print(a)
                        test_text_embedded_chars = server_bert.load_vector("embedding_case_test_2.npy", list(test_bx))  # [20 90 768)
                        feed_dict = {
                    ...
                    print("predict_shape:", predictions.shape)
