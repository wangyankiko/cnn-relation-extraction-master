...
from text_cnn_wy_trans_2 import TextCNN
import data_helpers
import utils
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                # Train
                # text_embedded_chars = server_bert.load_clean_vector("embedding_case.npy", list(train_bx),train_sentence_len) #[20 90 768]
                embedding_char = server_bert.load_vector("embedding_case.npy", list(train_bx))
                #print(text_embedded_chars.shape) #（20 90 768）
                feed_dict = {
                    cnn.embedding_chars:embedding_char,
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    for test_batch in test_batches:
                        ...
                        a = list(test_bx)
                        # print(a)
                        # test_text_embedded_chars = server_bert.load_clean_vector("embedding_case_test.npy", list(test_bx),test_sentence_len)  # [20 90 768)
                        test_embedding_chars = server_bert.load_vector("embedding_case_test.npy", list(test_bx))
                        feed_dict = {
                            cnn.embedding_chars:test_embedding_chars,
                            cnn.input_y:test_by,
