...
from transformaer_cnn import TextCNN
import data_helper2
import utils
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Generate batches
            batches = data_helper2.batch_iter(list(zip(train_y,train_x_pos,train_text)),
            ...
            for batch in batches:
                train_by, train_pos,train_bx = zip(*batch)
                # print(x_batch)
                # print(list(x_batch))
                ...
                if step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    # Generate batches
                    test_batches = data_helper2.batch_iter(list(zip(test_y,test_x_pos,test_text)),
                    ...
                    for test_batch in test_batches:
                        test_by,test_pos, test_bx = zip(*test_batch)
                        a = list(test_bx)
                        # print(a)
