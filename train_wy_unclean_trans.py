...
from text_cnn_transformer import TextCNN
import data_helpers
import utils
...
def train():
    ...
    id_to_x_text = {}
    id = []
    for i, str1 in enumerate(x_text):
        x_text_to_id[str1]=i
        id_to_x_text[i] = str1
        id.append(i)
    # print(x_text_to_id)
    ...
    # print("id_train:", id_train, "id_dev:", id_dev)
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # text_embedded_chars_dev = transformer.transformerencoder(text_embedded_chars_dev)
            ...
            for batch in batches:
                ...
                # Train
                # text_embedded_chars = server_bert.load_vector("embedding_unclean.npy", list(x_batch)) #[20 90 768]
                text_embedded_chars = server_bert.load_vector("embedding_unclean.npy", list(x_batch))
                # print(text_embedded_chars.shape)
                ...
                _, step, summaries, loss, accuracy,text_embedding_befir,text_cvalue= sess.run(
                    [train_op, global_step, train_summary_op, cnn.loss, cnn.accuracy,cnn.text_embedded_chars_change,cnn.text_embedded_chars_trans], feed_dict)
                ...
                if step % FLAGS.display_every == 0:
                    ...
                    print("text_trans_before:", text_embedding_befir)
                    print("text_value", text_cvalue)
