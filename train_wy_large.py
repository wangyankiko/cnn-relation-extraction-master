...
from text_cnn_wy_large import TextCNN
import data_helpers
import utils
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for batch in batches:
                ...
                # Train
                text_embedded_chars = server_bert.load_clean_vector_2("embedding_L24.npy", list(train_bx),train_sentence_len) #[20 90 768]
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    for test_batch in test_batches:
                        ...
                        a = list(test_bx)
                        # print(a)
                        test_text_embedded_chars = server_bert.load_clean_vector_2("embedding_L24_test.npy", list(test_bx),test_sentence_len)  # [20 90 768)
                        feed_dict = {
